...
## Описание `.env` файла:
### Для чистой и установки через Docker
...
### Для приложения
 ...
 - `DBMS_PATH` - путь до файла БД. В режиме чистой установки по данному пути находится символическая ссылка на сам файл БД, который находится в `/dbms`. **По умолчанию**: `volumes/dbms`
